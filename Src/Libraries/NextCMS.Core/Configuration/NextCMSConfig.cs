...
namespace NextCMS.Core.Configuration
{
    /// <summary>
    /// Represents a NextCMSConfig
    /// </summary>
    public partial class NextCMSConfig : IConfigurationSectionHandler
    {
        /// <summary>
