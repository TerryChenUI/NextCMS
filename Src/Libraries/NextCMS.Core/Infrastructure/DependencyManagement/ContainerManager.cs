            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        //if (service == null) throw new NextCMSException("Unkown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (NextCMSException)
                {

                }
            }
            throw new NextCMSException("No contructor was found that had all the dependencies satisfied.");
        }
